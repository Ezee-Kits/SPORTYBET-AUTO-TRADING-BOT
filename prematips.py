from func import requests_init,saving_files,drop_duplicate,match_day_date,main_date,save_daily_csv,sorting_values,saving_to_firebase
...
def prematips_func():
    ...
    path = path = f'{full_path}/prematips.csv'
    ...
    # saving_to_firebase(data=all_df,file_name='Prematips')
